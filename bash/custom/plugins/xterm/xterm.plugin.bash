...
# MODIFICATIONS (MB3hel): 
# - Don't show PROMPT_CHAR in precmd title
# - Don't show directory or user@host in preexec title
# - Use colon between user@host and path in precmd title
...
function _omb_plugin_xterm_preexec_title {
  ...
  local user=${OMB_PLUGIN_XTERM_SHORT_USER:-$USER}
  local host=${OMB_PLUGIN_XTERM_SHORT_HOSTNAME:-$HOSTNAME}
  _omb_plugin_xterm_set_title "$short_command"
}
